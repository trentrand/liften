...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
        ...
        GMSServices.provideAPIKey("AIzaSyANVkoIwLFTpiE5HipRnLJwX5jZUmcrmVM")
        // Register GooglePlaces api key
        FTGooglePlacesAPIService.provideAPIKey("AIzaSyDwSEcwaOzrhh24SQNVHCQS4gMgSUqTf4s")
        ...
        testObject.saveInBackgroundWithBlock({
            (saveResults: Bool!, error: NSError!) in
            NSLog("Results saved \(saveResults)")
        })
        return true
    }
